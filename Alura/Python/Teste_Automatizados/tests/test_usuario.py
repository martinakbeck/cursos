...
def test_deve_permit_propor_lance_quando_valor_eh_menor_que_valor_da_carteira(vini,leilao):
...
def test_nao_deve_permitir_propor_lance_com_valor_eh_maior_que_o_da_carteira(vini, leilao):
